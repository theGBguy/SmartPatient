...
import com.gbsoft.smartpatient.databinding.FragmentPatientRegisterBinding;
...
@AndroidEntryPoint
public class PatientRegisterFrag extends Fragment {
    private FragmentPatientRegisterBinding binding;
    private PatientRegVM viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(PatientRegVM.class);
